...
DropDuplicatesAccelerometer_node1680600980927 = DynamicFrame.fromDF(
    DropFieldsfromTrustedCustomer_node1680596775090.toDF().dropDuplicates(),
    glueContext,
    "DropDuplicatesAccelerometer_node1680600980927",
)

# Script generated for node S3 bucket
S3bucket_node3 = glueContext.write_dynamic_frame.from_options(
    frame=DropDuplicatesAccelerometer_node1680600980927,
    connection_type="s3",
    format="json",
    connection_options={
        "path": "s3://congdinh2023-stedi-lakehouse/accelerometer/trusted/",
        "partitionKeys": [],
    },
